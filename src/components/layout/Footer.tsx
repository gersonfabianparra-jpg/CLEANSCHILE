          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                { label: "Sellado Cerámico ✦",           idx: 1, href: "/sellado-ceramico" },
                { label: "Detallado Interior",           idx: 2 },
                { label: "Limpieza y Pulido de Llantas", idx: 3 },
                { label: "Tratamiento Pre-Venta",        idx: 4 },
                { label: "Mantención Automotriz",        idx: 5 },
                { label: "Pack Protección Invierno",     idx: 6 },
                { label: "Lavado Boutique",              idx: 7 },
                { label: "Detallado Motocicletas",       idx: 8 },
              ].map(({ label, idx, href }) => (
                <li key={label}>
                  <Link
                    href={href ?? `/?s=${idx}#servicios`}
                    style={{
                      fontFamily: "var(--font-inter)", fontSize: 13,
                      color: href ? "rgba(167,139,250,0.6)" : "rgba(203,213,225,0.38)",
                      textDecoration: "none",
