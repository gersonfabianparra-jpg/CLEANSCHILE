      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div ref={headRef} className="text-center mb-20">
          ...
          <div className="overflow-hidden">
            ...
            >
              EL <span className="gradient-text">PROCESO</span>
            </motion.h2>
          </div>
        </div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#25D366]/10 border border-[#25D366]/20 text-[#25D366] font-space text-sm font-medium hover:bg-[#25D366]/15 transition-all duration-300"
          >
